...
class Avaliacao(models.Model):
    ...
    tipoAvaliacao = models.CharField('Tipo de Avaliacao',max_length=2,choices=CHOICE_TIPO_AVALIACAO)
    tipoProva = models.CharField('Tipo de Prova',max_length=2,choices=CHOICE_TIPO_PROVA)
    class Meta:
        verbose_name=u'Avaliacao'
        verbose_name_plural=u'Avaliacoes'
    def __unicode__(self): 
        return self.dt_avaliacao     
