...
class Pessoa(models.Model): 
    ...
    rgorgexp = models.CharField(u'Órgão Expedidor',max_length=15,null=True,blank=True) 
    uf = models.CharField('UF',max_length=2,default='RJ',choices=STATE_CHOICES,null=True,blank=True) 
    estado = models.CharField('Estado',max_length=100,default='Rio de Janeiro',null=True,blank=True)
